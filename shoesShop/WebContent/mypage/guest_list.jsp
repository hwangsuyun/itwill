...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
 <%
 		String m_cellphone = request.getParameter("phone");
 		//System.out.println("phone:"+m_cellphone);
 		String m_email = request.getParameter("email");
 		//System.out.println("email:"+m_email);
		ArrayList<OrderDTO> List = null;
		OrderDTO orderDto = null;
		try{
			List = OrderManager.getOrdermanager().findGuest(m_cellphone,m_email);	
		}catch(Exception e){
													...
													<table cellpadding="0" cellspacing="1" width="100%"
														...
														<tbody>
															<tr align="center" height="30" bgcolor="#F1F1F1" >
																...
																<td class="date_fontcssd" width="20%">주문금액(수량)</td>
													...
													<table cellpadding="0" cellspacing="1" width="100%"
														...
														<tbody>
															<tr align="center" height="30" bgcolor="#f9f9f9">
																<td class="date_fontcssd" height="28" width="20%">비회원</td>
