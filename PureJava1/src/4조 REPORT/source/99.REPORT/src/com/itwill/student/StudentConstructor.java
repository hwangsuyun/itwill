...
public class StudentConstructor
{
	...
	public Student[] getStudentArray()
	{
		...
		//	String name  = (String)("싸이"+((int)(Math.random() * 1000) + 1));
			...
			else if(i == 7) name = "홍사장";
			else if(i == 8) name = "가기사";
			else if(i == 9) name = "나기사";
			else if(i == 10) name = "다기사";
			else if(i == 11) name = "사기사";
			...
			else if(i == 19) name = "하기사";
			else name = "홍대리";
			
			
			// ----- 6. 이름이 김대리 인 학생 반환 -----   이문제를 위해 하나는 꼭 넣어주자. 
			if(i == (studentArray.length -1)) name = "김대리";	
			studentArray[i] = new Student( (i+1), name, temp_kor, temp_eng, temp_mat );
		}		
