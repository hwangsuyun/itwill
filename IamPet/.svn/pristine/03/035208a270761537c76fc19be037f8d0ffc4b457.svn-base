...
<%if(passlist != null){ %>
 ...
 <form name="join"
			...
			<tr>
				<td height="20" class="t1">
					<table width="100%" border="1" cellspacing="0"
						...
						<tr align=left>															
							<td>
								<font color="gray" face="돋움">질문&nbsp;:&nbsp;<%=passlist.getId()%></font>
							</td>							
						</tr>	
						
						<tr align=left>
							<td>
								<font color="gray" face="돋움">답변&nbsp;:&nbsp;<input type="text" name="result" size="15"></font>																
							</td>							
						</tr>
	...
	<%}else{%>
		...
		<center><font color="gray" face="돋움"> 정보가 없습니다.</font></center>
