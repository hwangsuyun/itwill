...
// Modified by Jinseung Yagn form pioni Technology (2000. 5. 13)
...
public class MultipartRequest {
  ...
  protected boolean readNextPart(MultipartInputStreamHandler in,
    ...
    String line = toKsc5601(in.readLine());   
    ...
    if (filename == null) {
      ...
      String value = toKsc5601(readParameter(in, boundary));      
      if (value.equals("")) {
  ...
  */
  public String toKsc5601(String str) throws UnsupportedEncodingException{		
		String ksString = str;
		if(str != null) ksString = new String(str.getBytes("8859_1"), "KSC5601");
	   return ksString;
  }
