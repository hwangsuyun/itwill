		...
		<table width="90%" cellspacing="0" bordercolordark="white"
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						...
						<strong>&nbsp;<font color="#000000" face="돋움">회원번호&nbsp;</font></strong></td>
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">아이디&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<%-- <tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000">비밀번호&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">이름&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<%-- <tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000">주민번호&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000">비번찾기퀴즈&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000">비번찾기정답&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">주소&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">이메일&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">집전화&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<table width="100%" border="1" cellspacing="0"
					...
					<tr>
						<td height="25" width="20%" class="t1" bgcolor="#f0f0f0" align="right">
						<strong>&nbsp;<font color="#000000" face="돋움">휴대폰&nbsp;</font></strong></td>
						<td width="100%" class="t1">&nbsp;&nbsp;
			...
			<tr>
				...
				<a 	href="main.jsp?contentPage=update&m_no=<%=memberDto.getNo()%>&m_id=<%=memberDto.getId()%>">수정</a></td>
			</tr>
