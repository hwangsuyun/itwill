...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
	pageEncoding="EUC-KR"%>
<%	
	ArrayList<PetDTO> petall = PetManager.getPetManager().petAll();
	//String findGroup = "PECHIN";
	//ArrayList<PetDTO> petall = dao.findGroupPet(findGroup);
%>
<td width="60%" valign="top">
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr bgcolor="#FFFFFF">
			<td align="center" valign="middle"><img src="./images/shopping/shop_title.gif"></td>
		</tr>
	</table> 
	<!-- </marquee>  -->
	<table cellspacing=0 cellpadding=0 border=0>
								...
								<tr>
									<td>
										<a href="main.jsp?contentPage=shopping/pet_detail&c_name_code=<%=dto.getC_name_code()%>">
											<img width="160px" src='images/<%= dto.getC_part_code() %>/<%= dto.getC_name_code() %>/<%= dto.getC_name_code() %>_0001.jpg' border="0"
